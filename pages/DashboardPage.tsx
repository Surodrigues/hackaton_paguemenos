...
export default function DashboardPage({ onViewProfile }: DashboardPageProps) {
          ...
          <div className="space-y-4">
            ...
            {isSearching && (
              <div className="flex items-center justify-center py-4">
                <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-pagueMenos-blue"></div>
